...
public class UserRegistration {
    ...
    public static void register(String adminName, String userName, String pemFile,
                                String orgName, String caUrl) throws Exception {
        ...
        Identity user = Identities.newX509Identity(orgName, enrollment);
    ...
    public static void main2(String[] args) throws Exception {
        ...
        String admin1 = "admin";
        String appUser = "picassoUser";
        String value = "ca.org1.example.com-cert.pem";
        ...
        X509Identity adminIdentity = (X509Identity) wallet.get(admin1);
        if (adminIdentity == null) {
    ...
    public static void main3(String[] args) throws Exception {
        ...
        String appUser = "supermaket";
        String value = "ca.org2.example.com-cert.pem";
        String orgMSP = "Org2MSP";
        String url = "https://localhost:8054";
